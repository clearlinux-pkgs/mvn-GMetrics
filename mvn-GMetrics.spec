...
%package data
Summary: data components for the mvn-GMetrics package.
Group: Data

%description data
data components for the mvn-GMetrics package.
...
cp %{SOURCE0} %{buildroot}/usr/share/java/.m2/repository/org/gmetrics/GMetrics/0.7/GMetrics-0.7-sources.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/gmetrics/GMetrics/0.7
cp %{SOURCE1} %{buildroot}/usr/share/java/.m2/repository/org/gmetrics/GMetrics/0.7/GMetrics-0.7.jar
